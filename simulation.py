...
class Simulation:
    ...
    # 𝔈𝔳𝔢𝔫𝔱 𝔓𝔯𝔬𝔭𝔢𝔯𝔱𝔦𝔢𝔰:
        ...
        self.gen_random_velocities(max_speed=random_speed_range)
    ...
    def gen_random_velocities(self, max_speed):
    ...
    def update_patches(self):
        """ update_patches | Updates the animation with new positions of ball patches.
        """
