...
class Simulation:
    ...
    def glossary(self, pressure=False, test_pressure=False, temperature=False, 
        ...
        if distance_absolute: gloss["dist_centre"] = self._distance_absolute
        if distance_relative: gloss["dist_rel"] = self._distance_relative
    ...
    def record_temperature(self):
        ...
        if len(self._temperature) == self._collisions + 1:       # Completion.
    ...
    def record_temperature_moyen(self):
        ...
        """
        self._temperature_moyen = np.mean(self._temperature["T"]) # Change potentially
